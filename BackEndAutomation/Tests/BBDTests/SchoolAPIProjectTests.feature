...
Scenario: Teacher creates a class with subject 
	Given login data is being prepared
	And execute login API call with "teacher1" username and "teacher1" password
	When execute create class "Class1" API call with "Math"
...
Scenario: Teacher adds marks for the student
	Given login data is being prepared
	And execute login API call with "teacher1" username and "teacher1" password
	When add marks for student "Peter Ivanov" for subject "Math" API call with 5
...
Scenario: Parent sees the marks of their child
	...
	When get marks for student "Peter Ivanov" API call
